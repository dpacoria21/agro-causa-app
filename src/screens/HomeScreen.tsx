...
const goals: Goal[] = [
    {
        ...
        description: 'Proporcionar información climática precisa y accesible para todos. Buscamos empoderar a las personas con datos meteorológicos confiables para tomar decisiones informadas.',
    ...
    }, 
    {
        ...
        description: 'Creemos que el conocimiento del clima es crucial en la era del cambio climático. Nuestro proyecto busca crear conciencia y fomentar acciones sostenibles a través de la información.',
    ...
    {
        title: 'Quiénes Somos',
        description: 'Somos un equipo diverso de meteorólogos, desarrolladores y entusiastas del clima. Unidos por la pasión de hacer que los datos climáticos sean comprensibles y útiles para todos.',
